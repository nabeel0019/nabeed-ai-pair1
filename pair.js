        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "NABEED-AI~" + base64;

                    await sock.sendMessage(sock.user.id, { text: sessionId });

                    const successMsg = {
                        text:
                            `🚀 *NABEED-AI Session Created!*\n\n` +
                            `▸ *Never share* your session ID\n` +
                            `▸ Join our WhatsApp Channel\n` +
                            `▸ Report bugs on GitHub\n\n` +
                            `_Powered by NABEED-MD\n\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ https://github.com/NABEED-MD/NABEED-AI/tree/main/n` +
                            `▸ https://whatsapp.com/channel/0029VbBRaJY60eBd0QEORO0R`,
                        contextInfo: {
